...
cd /tmp
wget --no-check-certificate https://raw.githubusercontent.com/xddcore/SoftRouter/main/GL-MT1300/libcap/libcap_2.48-1_mipsel_24kc.ipk
opkg install /tmp/libcap_*.ipk
wget --no-check-certificate https://raw.githubusercontent.com/xddcore/SoftRouter/main/GL-MT1300/libcap/libcap-bin_2.48-1_mipsel_24kc.ipk
